...
2. Ve a SQL Editor → pega y ejecuta, en orden: `0001_init.sql`, `0002_fix_profile_rls.sql`, `0003_demo_requests.sql`, `0004_harden_security_definer.sql`, `0005_update_business_name.sql`
